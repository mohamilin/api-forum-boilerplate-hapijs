...
describe("DomainErrorTranslator", () => {
  it("should translate error correctly", () => {
    ...
    expect(
      DomainErrorTranslator.translate(new Error("THREAD.NOT_CONTAIN_NEEDED"))
    ).toStrictEqual(
      new InvariantError(
    ...
    expect(
      DomainErrorTranslator.translate(
        new Error("THREAD.NOT_MEET_DATA_TYPE_SPECIFICATION")
      )
    ).toStrictEqual(
      new InvariantError(
        "tidak dapat membuat thread baru karena karena tipe data tidak sesuai"
      )
    );
  });
